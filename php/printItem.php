<?php
function print_item($pic_id,$pic_url,$item_desc,$item_point){
            ...
            echo'<div class="card m-3">';
              ...
              echo'<div class="card-body">';
                ...
                echo'<div class="row px-3">';
                    ...
                    echo'<form method="POST" action="php/claim.php">';
                    echo"<input  type='hidden' name='item_id' id='item_id' value=$pic_id>";
                    echo'<div class="col text-end" style="color:#222020;font-family:"Helvetica, sans-serif";box-sizing:border-box;"><button class="btn btn-success" type="submit">Claim</button></div>';
                    echo'</form>';                
                    echo'</div>';
              echo'</div>';
            echo'</div>';
